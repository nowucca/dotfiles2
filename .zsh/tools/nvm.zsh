...
# Install NVM if not present (fully silenced — it's a one-time workspace setup)
[ ! -d "$NVM_DIR" ] && curl -fsSL https://raw.githubusercontent.com/nvm-sh/nvm/refs/heads/master/install.sh | bash > /dev/null 2>&1
